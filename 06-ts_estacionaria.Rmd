...
De acuerdo a la estimación puntual, un aumento de un punto en la tasa de desempleo disminuye la inflación no anticipada en 0.016 puntos. Podemos calcular $td^n=-\alpha/\beta$, lo que nos da `r -0.0020880/-0.0162264`. En línea con ejercicios que estiman la NAIRU para Colombia.
